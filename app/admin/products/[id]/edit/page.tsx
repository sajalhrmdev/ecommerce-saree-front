...
export default function EditProductPage() {
  ...
  if (loading) return <div className="max-w-3xl mx-auto px-4 py-20 text-center text-gray-500">Loading...</div>;
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input name="name" value={form.name} onChange={(e) => { handleChange(e); setForm(f => ({ ...f, slug: e.target.value.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "") })); }}
