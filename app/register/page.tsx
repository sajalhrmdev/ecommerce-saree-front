    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-gradient-to-br from-cream to-white">
      <div className="w-full max-w-md premium-card p-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Join the Saree Elegance family</p>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/login" className="text-gold-600 hover:text-gold-700 font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </div>
